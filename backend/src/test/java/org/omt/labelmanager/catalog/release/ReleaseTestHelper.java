...
/**
 * Public helper for creating test release data. Used by integration tests in other modules that
 * need release fixtures.
 */
@Component
public class ReleaseTestHelper {
    ...
    public ReleaseTestHelper(
            ReleaseRepository releaseRepository, ReleaseCommandApi releaseCommandFacade) {
        this.releaseRepository = releaseRepository;
        this.releaseCommandFacade = releaseCommandFacade;
    }

    public Long createRelease(String name, Long labelId, Long artistId) {
    ...
    public Long createReleaseEntity(String name, Long labelId) {

...
/**
 * Validates a return line item against current inventory and adds it to the return entity. Shared
 * by {@link RegisterReturnUseCase} and {@link UpdateReturnUseCase} to avoid duplicating inventory
...
class ReturnLineItemProcessor {
    ...
    /**
     * Validates that the distributor holds enough current inventory for the line item, then adds it
    ...
    Long validateAndAdd(
        ...
        log.debug(
                "Processed return line item: release={}, format={}, quantity={}",
                lineItemInput.releaseId(),
                lineItemInput.format(),
                lineItemInput.quantity());

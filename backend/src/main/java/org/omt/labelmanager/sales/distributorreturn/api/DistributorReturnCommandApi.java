...
public interface DistributorReturnCommandApi {
    ...
    /**
     * Registers a new return of physical inventory from a distributor back to the warehouse. For
     * each line item, validates that the distributor currently holds enough inventory before
     * recording RETURN movements.
     *
     ...
     * @throws IllegalArgumentException if lineItems is empty or the distributor is not found under
     *     the label
     * @throws org.omt.labelmanager.inventory.InsufficientInventoryException if the distributor does
     *     not hold enough inventory for any of the line items
     */
     ...
     */
    void updateReturn(
            Long returnId, LocalDate returnDate, String notes, List<ReturnLineItemInput> lineItems);

...
1. Read `spec.md`, `tasks.md`, and `progress.md` fully before writing any code.
2. Update `index.md`: set Implementation phase to `In Progress`.
3. Work through tasks in order, in small increments. For each task, follow the TDD cycle:
